...
const MENU_TIPS = [
  // 山珍海味
  "蒸熊掌", "蒸鹿尾", "烧花鸭", "烧雏鸡", "烧子鹅", "卤鸭", "卤鸡", "卤蛋", "卤肉", "卤豆腐",
  "酱鸡", "酱鸭", "酱肘子", "酱排骨", "酱牛肉", "熏鸡", "熏鸭", "熏肉", "熏鱼", "熏豆腐",
  // 煎炒烹炸
  "烤鸡", "烤鸭", "烤鱼", "烤肉", "烤虾", "炒肉片", "炒肉丝", "炒肉丁", "炒鸡蛋", "炒鸭蛋",
  "溜肉片", "溜肉丝", "溜鸡片", "溜鸭片", "溜鱼片", "炸肉段", "炸虾仁", "炸鸡排", "炸鱼排", "炸豆腐",
  // 汤类
  "酸辣汤", "鸡蛋汤", "肉丝汤", "豆腐汤", "酸菜白肉", "羊肉萝卜", "牛肉土豆", "鸡肉蘑菇", "鱼头豆腐", "排骨玉米",
  // 主食
  "炒米饭", "炒面条", "烙大饼", "蒸馒头", "煮水饺", "炸油条", "煎包", "烧麦", "混沌", "炸酱面",
  // 甜品
  "拔丝苹果", "拔丝香蕉", "蜂蜜蛋糕", "桂花酥", "核桃酥", "麻花", "江米条", "艾窝窝", "糖耳朵", "萨其马",
];
